      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoBox}>
          <View style={styles.infoRow}>
            <Icon name="mail-outline" size={22} color="#22D3EE" />
            <Text style={styles.infoText}>{tech?.email || "Not added"}</Text>
          </View>

          <View style={styles.infoRow}>
            <Icon name="briefcase-outline" size={22} color="#22D3EE" />
            <Text style={styles.infoText}>{tech?.category}</Text>
          </View>

          <View style={styles.infoRow}>
            <Icon name="location-outline" size={22} color="#22D3EE" />
            <Text style={styles.infoText}>{tech?.area}</Text>
          </View>

          {tech?.vehicle && (
            <View style={styles.infoRow}>
              <Icon name="car-outline" size={22} color="#22D3EE" />
          ...
          {tech?.expertise && (
            <View style={styles.infoRow}>
              <Icon name="sparkles-outline" size={22} color="#22D3EE" />
          ...
          {tech?.experience && (
            <View style={styles.infoRow}>
              <Icon name="time-outline" size={22} color="#22D3EE" />
        ...
        <TouchableOpacity style={styles.logoutBtn} onPress={logout}>
          <Icon name="log-out-outline" size={22} color="#0F172A" />
